...
string fYAxisLabels[NVARIABLES] = { "Events / 2.0 GeV/c^{2}","Events / 2.0 GeV/c^{2}","Events","Events","Events","Events","Events","Events","Events","Events / 10.0 GeV/c^{2}","Events / 10.0 GeV/c^{2}","Events / 10.0 GeV/c^{2}",  };
...
//     cout << "here8\n";   
  ...
  TLegend *tmpLegend = new TLegend(0.35,0.65,0.9,0.90);
  tmpLegend->SetTextSize(0.04);
  tmpLegend->SetBorderSize(1);
  tmpLegend->AddEntry(totalBkgDistributions_MC[11], "MC Simulation", "F");
  tmpLegend->AddEntry(dataDistributions_LooseLoosePrediction[11], "Data Fake Rate Prediction", "LP");


  totalBkgDistributions_MC[11]->SetMaximum(0.015); 
  ...
  cv1->SaveAs("TotalBackgroundFakeRatePrediction_Data.eps"); 
  ...
  totalBkgDistributions_MC[11]->SetMaximum(0.01);
  totalBkgDistributions_MC[11]->SetFillStyle(1001);
  totalBkgDistributions_MC[11]->SetFillColor(kMagenta);
  totalBkgDistributions_MC[11]->GetYaxis()->SetTitleOffset(1.5);
  totalBkgDistributions_MC[11]->GetXaxis()->SetTitleOffset(1.0);
  ...
  cv1->SaveAs("TotalBackgroundFakeRatePrediction_MC.eps"); 
  ...
  tmpLegend1->SetBorderSize(1);
  tmpLegend1->AddEntry(signalDistributions_LooseLoosePrediction[11], "Signal Fake Rate Prediction", "LP");
  ...
  cv1->SaveAs("FakeRateMethodPrediction_Zee.eps");
  ...
  for (int p=0; p<processLabel.size() ; ++p) {
    ...
    cv->SaveAs(("FakeRateMethodPrediction_" + processLabel[p] + ".eps").c_str());
