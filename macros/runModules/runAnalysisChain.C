// $Id: runAnalysisChain.C,v 1.1 2008/08/30 14:02:16 sixie Exp $
...
)
{
  ...
  ana->AddFile(files);
//  ana->SetOutputName("mit-ZeeAnalysis-hist.root");
  //ana->SetOutputName("mit-WmunuAnalysis-hist.root");
//  ana->SetOutputName("mit-HWWSelection-Wenu-hist.root");
//  ana->SetOutputName("mit-HWWSelection-Wmunu-hist.root");
//  ana->SetOutputName("mit-HWWSelection-Zee-hist.root");
//  ana->SetOutputName("mit-HWWSelection-ttbar-hist.root");
  ana->SetOutputName("mit-HWWSelection-hist-HWW-hist.root");
