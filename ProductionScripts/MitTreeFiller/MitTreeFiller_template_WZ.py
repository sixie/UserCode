...
process.source = cms.Source("PoolSource",
   ...
   'file:/server/02a/sixie/RECO/WZ_3l_IDEAL_V9_py_RAW2DIGI_RECO_1.root',
   'file:/server/02a/sixie/RECO/WZ_3l_IDEAL_V9_py_RAW2DIGI_RECO_2.root'
                             ),
...
process.TreeService = cms.Service("TreeService",
    fileNames = cms.untracked.vstring('mitPrivateWZ_3l-id9')
)
