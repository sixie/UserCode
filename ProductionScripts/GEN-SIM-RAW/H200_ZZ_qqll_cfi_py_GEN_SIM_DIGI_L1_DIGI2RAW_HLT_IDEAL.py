...
# with command line options: Configuration/GenProduction/python/H200_ZZ_qqll_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 200 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/H200_ZZ_qqll_cfi.py nevts:200'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('H200_ZZ_qqll_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
