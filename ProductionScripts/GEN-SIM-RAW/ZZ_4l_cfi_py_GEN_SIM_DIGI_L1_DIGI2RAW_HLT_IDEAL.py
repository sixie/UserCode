...
# with command line options: Configuration/GenProduction/python/ZZ_4l_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 200 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/ZZ_4l_cfi.py nevts:200'),
...
process.source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0                  !0=full user control (then use MSUB)', 
            'MSUB(22)=1              !ffbar->Z/gamma Z/gammaMDME( 174,1) = 0    !Z decay into d dbar', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ZZ_4l_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
