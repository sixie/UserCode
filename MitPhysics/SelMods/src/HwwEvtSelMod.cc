 // $Id: HwwEvtSelMod.cc,v 1.1 2008/11/12 15:04:49 sixie Exp $
...
//        double deltaR = MathUtils::DeltaR(CleanJets->At(j)->Mom(),fJets->At(i)->Mom());  
  ...
  if (leptonType[0] == "mu" && leptonType[1] == "mu" ){ // mumu
    ...
    if(leptons[0]->Pt()	> 35.0   &&
       leptons[0]->Pt()	< 55.0)          passCut[5] = true;
    if(leptons[1]->Pt()	> 25.0)          passCut[6] = true;
  }
    ...
    if(dilepton->Mass()	  < 40.0)        passCut[4] = true;
	 ...
	 leptons[0]->Pt() < 49.0)        passCut[5] = true;
      if(leptons[1]->Pt() > 25.0)        passCut[6] = true;
  }      
    ...
    if(leptons[0]->Pt()	> 25.0   &&
       leptons[0]->Pt()	< 50.0)  passCut[5] = true;
    if(leptons[1]->Pt()	> 25.0)  passCut[6] = true;
  }

  if (DirtyMuons->GetEntries() < 1)      passCut[7] = true;
  if (CleanTracks->GetEntries() < 4)     passCut[8] = true;
  ...
  //***********************************************************************************************
    ...
    if (k==8 && passPreviousCut) {
      fNCleanExtraTracksHist->Fill(CleanTracks->GetEntries());
      if (leptonType[0] == "e" && leptonType[1] == "e") {
        fNCleanExtraTracksHist_ee->Fill(CleanTracks->GetEntries());
      } else if (leptonType[0] == "mu" && leptonType[1] == "mu" ) {
        fNCleanExtraTracksHist_mumu->Fill(CleanTracks->GetEntries());
      } else {
        fNCleanExtraTracksHist_emu->Fill(CleanTracks->GetEntries());
      }
    }
  ...
  if (pass) {
    fNCleanExtraTracksHist_NMinusOne->Fill(CleanTracks->GetEntries());
    if (leptonType[0] == "e" && leptonType[1] == "e") {
      fNCleanExtraTracksHist_NMinusOne_ee->Fill(CleanTracks->GetEntries());
    } else if (leptonType[0] == "mu" && leptonType[1] == "mu" ) {
      fNCleanExtraTracksHist_NMinusOne_mumu->Fill(CleanTracks->GetEntries());
    } else {
      fNCleanExtraTracksHist_NMinusOne_emu->Fill(CleanTracks->GetEntries());
    }
  }     
...
//*************************************************************************************************
  ...
  fHWWToMuMuSelection = new TH1D("hHWWToMuMuSelection", ";Cut Number;Number of Events", 
                                 9, -1.5, 7.5);
  fHWWToEMuSelection  = new TH1D("hHWWToEMuSelection", ";Cut Number;Number of Events", 
                                9, -1.5, 7.5);
...
//*************************************************************************************************
  ...
  fMetPhiHist_NMinusOne_mumu            = new TH1D("hMetPhiHist_NMinusOne_mumu",
                                                   ";#phi;Number of Events",28,-3.5,3.5);
  fMETdeltaPhilEtHist_NMinusOne_mumu    = new TH1D("hMETdeltaPhilEtHist_mumu",
                                                   ";METdeltaPhilEtHist;Number of Events",
                                                   150,0.,300.);  
...
//*************************************************************************************************
  ...
  fSumEt_afterCuts                 = new TH1D("hSumEt_afterCuts",";SumEt;Number of Events",
                                              100,0.,500.);
  fLepton1Pt_afterCuts             = new TH1D("hLepton1Pt_afterCuts",
                                       ";Lepton1Pt_afterCuts;Number of Events",150,0.,150.);
  fLepton2Pt_afterCuts             = new TH1D("hLepton2Pt_afterCuts",
                                              ";Lepton2Pt_afterCuts;Number of Events", 150,0.,150.);
  ...
  fSumEt_afterCuts_ee                = new TH1D("hSumEt_afterCuts_ee",";SumEt;Number of Events",
                                                100,0.,500.);
  fLepton1Pt_afterCuts_ee            = new TH1D("hLepton1Pt_afterCuts_ee",
                                                ";Lepton1Pt_afterCuts;Number of Events",
                                                150,0.,150.);
  fLepton2Pt_afterCuts_ee            = new TH1D("hLepton2Pt_afterCuts_ee",
                                                ";Lepton2Pt_afterCuts;Number of Events",
                                                150,0.,150.);
  ...
  fSumEt_afterCuts_mumu                = new TH1D("hSumEt_afterCuts_mumu",";SumEt;Number of Events",
                                                  100,0.,500.);
  fLepton1Pt_afterCuts_mumu            = new TH1D("hLepton1Pt_afterCuts_mumu",
                                       ";Lepton1Pt_afterCuts;Number of Events",150,0.,150.);
  fLepton2Pt_afterCuts_mumu            = new TH1D("hLepton2Pt_afterCuts_mumu",
                                                  ";Lepton2Pt_afterCuts;Number of Events",
                                                  150,0.,150.);
  ...
  fSumEt_afterCuts_emu                = new TH1D("hSumEt_afterCuts_emu",";SumEt;Number of Events",
                                                 100,0.,500.);
  fLepton1Pt_afterCuts_emu            = new TH1D("hLepton1Pt_afterCuts_emu",
                                                 ";Lepton1Pt_afterCuts;Number of Events",
                                                 150,0.,150.);
  fLepton2Pt_afterCuts_emu            = new TH1D("hLepton2Pt_afterCuts_emu",
                                                 ";Lepton2Pt_afterCuts;Number of Events",
                                                 150,0.,150.);
  ...
  AddOutput(fLepton1Pt_afterCuts_ee);                        
  AddOutput(fLepton2Pt_afterCuts_ee);                       
  ...
  AddOutput(fLepton1Pt_afterCuts_mumu);                        
  AddOutput(fLepton2Pt_afterCuts_mumu);                       
  ...
  AddOutput(fLepton1Pt_afterCuts_emu);                        
  AddOutput(fLepton2Pt_afterCuts_emu);                       
