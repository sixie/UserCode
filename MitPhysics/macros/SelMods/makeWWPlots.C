...
//  string specialLabel = "_N-1_CaloJets";
  string specialLabel = "_Sequential";
  
  string filename_signal = "WWSelection_WW_2l" + specialLabel + ".root";
  double scaleFactorSignal = 114.3*0.106*0.5/10000 * 1000;

  vector<string> filenames;
  vector<string> datasetnames;
  vector<double> scaleFactors;
  filenames.push_back("WWSelection_WW_2l" + specialLabel + ".root");
  datasetnames.push_back("WW");
  scaleFactors.push_back(114.3*0.106*0.5/10000 * 1000);
  filenames.push_back("WWSelection_ttbar_dilepton" + specialLabel + ".root");
  datasetnames.push_back("TTBAR");
  scaleFactors.push_back(450*0.0123/20000 * 1000);
  filenames.push_back("WWSelection_H165WW_2l" + specialLabel + ".root");
  datasetnames.push_back("HWW");
  scaleFactors.push_back(2.34*0.5/20000 * 1000);
...
//   scaleFactors.push_back(11850/1000000 * 1000);
  ...
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal, "WW Signal", "hWWSelection", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METDeltaPhilEt_NMinusOne";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_NMinusOne", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METdeltaPhilEtHist_afterCuts";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_afterCuts", plotname+specialLabel);
  ...
  plotname = "MtWW_afterCuts";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,   "WW Signal", "hMtWW_afterCuts", plotname+specialLabel);
...
//   makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal, "WW Signal", "hWWSelection_ee", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METDeltaPhilEt_NMinusOne_ee";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_NMinusOne_ee", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METdeltaPhilEtHist_afterCuts_ee";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_afterCuts_ee", plotname+specialLabel);
  ...
  plotname = "MtWW_afterCuts_ee";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,   "WW Signal", "hMtWW_afterCuts_ee", plotname+specialLabel);
...
//   makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal, "WW Signal", "hWWSelection_mumu", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METDeltaPhilEt_NMinusOne_mumu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_NMinusOne_mumu", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METdeltaPhilEtHist_afterCuts_mumu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_afterCuts_mumu", plotname+specialLabel);
  ...
  plotname = "MtWW_afterCuts_mumu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,   "WW Signal", "hMtWW_afterCuts_mumu", plotname+specialLabel);
...
//   makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal, "WW Signal", "hWWSelection_emu", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METDeltaPhilEt_NMinusOne_emu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_NMinusOne_emu", plotname+specialLabel);
...
//*************************************************************************************************
  ...
  plotname = "METdeltaPhilEtHist_afterCuts_emu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,  "WW Signal", "hMETdeltaPhilEtHist_afterCuts_emu", plotname+specialLabel);
  ...
  plotname = "MtWW_afterCuts_emu";
  //makeStackedPlot(filenames, scaleFactors, datasetnames, filename_signal, scaleFactorSignal,   "WW Signal", "hMtWW_afterCuts_emu", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMetPtHist_NMinusOne", "Met", "below", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDeltaPhiLeptons_NMinusOne", "DeltaPhiLeptons", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne", "DileptonMass", "below", plotname+specialLabel);
  plotname = "DileptonMassCutOptimizationVsSigEff";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne", "below", plotname+specialLabel);

  plotname = "METdeltaPhilEtHistCutOptimization";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne", "METdeltaPhilEtHist", "below", plotname+specialLabel);
  plotname = "METdeltaPhilEtHistCutOptimizationVsSigEff";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne", "below", plotname+specialLabel);

  plotname = "NCleanExtraTracksHistCutOptimization";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hNCleanExtraTracksHist_NMinusOne", "NCleanExtraTracksHist", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMetPtHist_NMinusOne_ee", "Met", "below", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDeltaPhiLeptons_NMinusOne_ee", "DeltaPhiLeptons", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_ee", "DileptonMass", "below", plotname+specialLabel);
  plotname = "DileptonMassCutOptimizationVsSigEff_ee";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_ee",  "below", plotname+specialLabel);

  plotname = "METdeltaPhilEtHistCutOptimization_ee";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_ee", "METdeltaPhilEtHist", "below", plotname+specialLabel);
  plotname = "METdeltaPhilEtHistCutOptimizationVsSigEff_ee";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_ee",  "below", plotname+specialLabel);

  plotname = "NCleanExtraTracksHistCutOptimization_ee";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hNCleanExtraTracksHist_NMinusOne_ee", "NCleanExtraTracksHist", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMetPtHist_NMinusOne_mumu", "Met", "below", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDeltaPhiLeptons_NMinusOne_mumu", "DeltaPhiLeptons", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_mumu", "DileptonMass", "below", plotname+specialLabel);
  plotname = "DileptonMassCutOptimizationVsSigEff_mumu";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_mumu",  "below", plotname+specialLabel);

  plotname = "METdeltaPhilEtHistCutOptimization_mumu";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_mumu", "METdeltaPhilEtHist", "below", plotname+specialLabel);
  plotname = "METdeltaPhilEtHistCutOptimizationVsSigEff_mumu";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_mumu",  "below", plotname+specialLabel);

  plotname = "NCleanExtraTracksHistCutOptimization_mumu";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hNCleanExtraTracksHist_NMinusOne_mumu", "NCleanExtraTracksHist", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMetPtHist_NMinusOne_emu", "Met", "below", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDeltaPhiLeptons_NMinusOne_emu", "DeltaPhiLeptons", "above", plotname+specialLabel);
  ...
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_emu", "DileptonMass", "below", plotname+specialLabel);
  plotname = "DileptonMassCutOptimizationVsSigEff_emu";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hDileptonMass_NMinusOne_emu",  "below", plotname+specialLabel);

  plotname = "METdeltaPhilEtHistCutOptimization_emu";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_emu", "METdeltaPhilEtHist", "below", plotname+specialLabel);
  plotname = "METdeltaPhilEtHistCutOptimizationVsSigEff_emu";
  makeOptimizationVsSigEff(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hMETdeltaPhilEtHist_NMinusOne_emu",  "below", plotname+specialLabel);

  plotname = "NCleanExtraTracksHistCutOptimization_emu";
  optimizeCut(filenames, scaleFactors, filename_signal, scaleFactorSignal, "hNCleanExtraTracksHist_NMinusOne_emu", "NCleanExtraTracksHist", "above", plotname+specialLabel);
