// $Id: runHWWSelection.C,v 1.1 2008/11/12 15:04:52 sixie Exp $
...
void runHWWSelection()
{
  ...
  TString files6      = TString("/castor/cern.ch/user/p/paus/filler/004/s8-zee-id9/*.root");
  datasetname = "Z";
  ...
  //Try all jets
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_IC5Jets.root").c_str()), cutType, TString("CaloJets"));
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_SC5Jets.root").c_str()), cutType, TString("SisCone5Jets"));
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_SC7Jets.root").c_str()), cutType, TString("SisCone7Jets"));
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_KT4Jets.root").c_str()), cutType, TString("Kt4Jets"));
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_KT6Jets.root").c_str()), cutType, TString("Kt6Jets"));
//   runHWWAnalysisChain(files1, TString(("mit-HWWSelection-003-hist_" + datasetname + "_IC5JPT.root").c_str()), cutType, TString("IC5JetPlusTrack"));


  //Test HLT Triggers
  TString tempfiles1      = TString("/server/04d/sixie/OAKSamples/004/mitPrivateH165WW_2l-id9/mitPrivateH165WW_2l-id9_*.root");
  datasetname = "HWW";
  runHLTAnalysis(tempfiles1, TString(("mit-HLTAnalysis-004-hist_" + datasetname + "_" + JetName+".root").c_str()));
