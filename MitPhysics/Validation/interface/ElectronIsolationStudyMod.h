//--------------------------------------------------------------------------------------------------
// $Id: ElectronIsolationStudyMod.h,v 1.1 2008/11/12 15:04:50 sixie Exp $
//
...
#ifndef MITANA_VALIDATION_ELECTRONISOLATIONSTUDYMOD_H
#define MITANA_VALIDATION_ELECTRONISOLATIONSTUDYMOD_H
...
namespace mithep 
{
  class ElectronIsolationStudyMod : public BaseMod
  {
    ...
    protected:
      ...
      TH2D                    *fElectronTrackIsoVsHcalJurassicIso;
      ...
      TH1D                    *fElectronHcalJurassicIsoOverPt;
      ...
      TH1D                    *fNElectronPassHcalJurassicIsoCut;
      ...
      TH1D                    *fNElectronPassHcalJurassicIsoOverPtCut;
      ...
      TH1D                    *fElectronHcalJurassicIsoCutEff;         
      ...
      TH1D                    *fElectronHcalJurassicIsoOverPtCutEff;         
      ...
      TH2D                    *fElectronJurassicHcalIsoVsPt; 
