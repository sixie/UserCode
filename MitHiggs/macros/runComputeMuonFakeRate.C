//root -l -q -b  $CMSSW_BASE/src/MitHiggs/macros/runMacros/runComputeMuonFakeRate.C+\(\"0000\",\"f8-wjets-mg-id9\",\"mit/filler/006\",\"/home/mitprod/catalog\",\"FakeTest\",-1,-1\)
//root -l -q -b  $CMSSW_BASE/src/MitHiggs/macros/runMacros/runComputeMuonFakeRate.C+\(\"0000\",\"s8-wtau-id9\",\"mit/filler/006\",\"/home/mitprod/catalog\",\"FakeTest\",-1,-1\)
// $Id: runComputeMuonFakeRate.C,v 1.1 2009/02/21 13:04:55 sixie Exp $
                        ...
                        int         nEvents    = -1)
{
  ...
  analysisMod->SetVetoLeadingJet(kFALSE);
                        ...
                        int         runTypeIndex = -1)
{
  ...
  if (runTypeIndex == -1) {
    executeComputeMuonFakeRateMod(fileset,dataset,book,catalogDir,outfileName,nEvents);
  }
}
