//root -l $CMSSW_BASE/src/MitHiggs/macros/plotMacros/makeElectronIDChargeCorrelationPlots.C+
...
// 
//--------------------------------------------------------------------------------------------------
void compareSSOSDistributions( vector<string> datasetfiles, vector<string> datasetnames,
                               string variableName, string isolation = "" ) {
  ...
  string plotname = isolation + "Electron" + variableName ;
  TCanvas *cv = MakeCanvas("cv", plotname.c_str(), 800, 600);
  ...
  SSDistribution->SetMarkerColor(kBlue);
  SSDistribution->SetLineColor(kBlue);
  OSDistribution->SetMarkerColor(kRed);
  OSDistribution->SetLineColor(kRed);

  TH1F *SSOSRatio = (TH1F*)SSDistribution->Clone(("SSOSRatio_"+isolation + "Electron" + variableName).c_str());
  SSOSRatio->GetYaxis()->SetTitle("Number of Events");
  SSOSRatio->Divide(OSDistribution);
  
  leg1->AddEntry(SSDistribution,"SameSign", "LP");
  leg1->AddEntry(OSDistribution,"OppositeSign", "LP");

  SSDistribution->Draw("hist");
  OSDistribution->Draw("samehist");
  leg1->Draw();
...
// Main of the macro
//--------------------------------------------------------------------------------------------------
void makeElectronIDChargeCorrelationPlots()
{
...
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"HOverE", "");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaEtaEta", "");
//   //makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaiEtaiEta", "");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaPhi", "");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaEta", "");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"fBrem", "");
  
  
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"HOverE", "Isolated");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaEtaEta", "Isolated");
//   //makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaiEtaiEta", "Isolated");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaPhi", "Isolated");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaEta", "Isolated");
//   makeSSOSRatioAsFunctionOfVariableCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"fBrem", "Isolated");
  
//   makeSSOSRatioAsFunctionOfEOverPCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames);
//   makeSSOSRatioAsFunctionOfEOverPCut(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Isolated");
  
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Classification");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Classification", "Isolated");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Classification", "Clean");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Eta");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Eta", "Isolated");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Eta", "Clean");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Phi");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Phi", "Isolated");
//   makeSSOSRatioVsVariable(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames, "Phi", "Clean");
    
  compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"HOverE", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaEtaEta", "Clean");
//   //compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"SigmaiEtaiEta", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaPhi", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"DeltaEta", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"fBrem", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"HOverE", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"Classification", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"Eta", "Clean");
   compareSSOSDistributions(pythiaWJetsDatasetFiles,pythiaWJetsDatasetNames,"Phi", "Clean");
