// $Id: runWWEventSelectionOptimizationTreeCreatorMod.C,v 1.1 2009/03/06 16:50:05 phedex Exp $
...
#include "MitHiggs/Optimization/interface/WWEventSelectionOptimizationTreeCreatorMod.h"
#endif

//--------------------------------------------------------------------------------------------------
void executeWWEventSelectionOptimizationTreeCreatorMod(const char *fileset  = "",
                        const char *dataset    = "s8-ttbar-id9",
                        const char *book       = "mit/filler/006",
                        const char *catalogDir = "/home/mitprod/catalog",
                        const char *outputName = "WWEventSelectionOptimizationTreeCreatorMod",
                        int         nEvents    = -1)
{
  //------------------------------------------------------------------------------------------------
  // some global setups
  ...
  jetID->SetJetBranchName(TString("SisCone5Jets"));
  ...
  // analyses modules
  //------------------------------------------------------------------------------------------------
  WWEventSelectionOptimizationTreeCreatorMod  *analysisMod = 
    new WWEventSelectionOptimizationTreeCreatorMod;
  ...
  //ana->AddDataset(d);
  ana->AddFile("/server/05b/mitdata/filler/006/s8-ww2l-id9/*.root");
  //ana->AddFile("castor:/castor/cern.ch/user/p/paus/filler/006/s8-ww2l-id9/*.root");
...
//--------------------------------------------------------------------------------------------------
void runWWEventSelectionOptimizationTreeCreatorMod(const char *fileset      = "",
                        const char *dataset      = "s8-ttbar-id9",
                        const char *book         = "mit/filler/006",
                        const char *catalogDir   = "/home/mitprod/catalog",
                        ...
                        int         runTypeIndex = -1)
{
  ...
  if (runTypeIndex == -1) {
    executeWWEventSelectionOptimizationTreeCreatorMod(fileset,dataset,book,catalogDir,outfileName,nEvents);
  }
}
