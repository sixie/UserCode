//root -l -q -b  $CMSSW_BASE/src/MitHiggs/macros/runMacros/runElectronIDChargeCorrelationStudy.C+\(\"0000\",\"s8-wm-id9\",\"mit/filler/006\",\"/home/mitprod/catalog\",\"ElectronIDChargeCorrelationTest\",100,-1\)

// $Id: runElectronIDChargeCorrelationStudy.C,v 1.1 2009/03/06 16:50:04 phedex Exp $
...
void executeComputeElectronFakeRateMod(const char *fileset  = "",
                        ...
                        const char *outputName = "ElectronIDChargeCorrelationStudy",
                        int         nEvents    = -1)
{
  //------------------------------------------------------------------------------------------------
  // some global setups
  ...
  // analyses modules
  //------------------------------------------------------------------------------------------------
  ElectronIDChargeCorrelationStudyMod *analysisMod = new ElectronIDChargeCorrelationStudyMod;
...
//--------------------------------------------------------------------------------------------------
void runElectronIDChargeCorrelationStudy(const char *fileset      = "",
                        const char *dataset      = "s8-ttbar-id9",
                        const char *book         = "mit/filler/006",
                        const char *catalogDir   = "/home/mitprod/catalog",
                        const char *outputName   = "ElectronIDChargeCorrelationStudy",
