//--------------------------------------------------------------------------------------------------
// $Id: ZmumuAnalysisMod.h,v 1.2 2008/12/04 19:19:49 sixie Exp $
//
// ZmumuAnalysisMod
//
...
#ifndef EWKMODS_ZMUMUANALYSISMOD_H
#define EWKMODS_ZMUMUANALYSISMOD_H
...
namespace mithep 
{
  class ZmumuAnalysisMod : public BaseMod
  {
    public:
      ZmumuAnalysisMod(const char *name="ZmumuAnalysisMod", 
    ...
    protected:
      ...
      ClassDef(ZmumuAnalysisMod,1) // TAM example analysis module
  };
}
#endif
