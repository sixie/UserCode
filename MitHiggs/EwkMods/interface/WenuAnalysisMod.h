//--------------------------------------------------------------------------------------------------
// $Id: WenuAnalysisMod.h,v 1.2 2008/12/04 19:19:49 sixie Exp $
//
// WenuAnalysisMod
//
...
#ifndef EWKMODS_WENUANALYSISMOD_H
#define EWKMODS_WENUANALYSISMOD_H
...
namespace mithep 
{
  class WenuAnalysisMod : public BaseMod
  {
    public:
      WenuAnalysisMod(const char *name="WenuAnalysisMod", 
    ...
    protected:
      ...
      ClassDef(WenuAnalysisMod,1) // TAM example analysis module
  };
}
#endif
