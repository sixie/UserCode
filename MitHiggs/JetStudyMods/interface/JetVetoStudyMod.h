//--------------------------------------------------------------------------------------------------
// $Id: JetVetoStudyMod.h,v 1.2 2008/12/04 19:19:50 sixie Exp $
//
// NJetStudyMod
//
...
#ifndef MITHIGGS_JETSTUDYMODS_JETVETOSTUDYMOD_H
#define MITHIGGS_JETSTUDYMODS_JETVETOSTUDYMOD_H
...
namespace mithep 
{
  class JetVetoStudyMod : public BaseMod
  {
    ...
    protected:
      ...
      const GenJetCol         *fGenJets;              //!Jet branch
