// $Id: WJetChargeCorrelationStudyMod.cc,v 1.1 2009/03/06 16:50:55 phedex Exp $
...
ClassImp(mithep::WJetChargeCorrelationStudyMod)

//--------------------------------------------------------------------------------------------------
  WJetChargeCorrelationStudyMod::WJetChargeCorrelationStudyMod(const char *name, const char *title) : 
  BaseMod(name,title),
...
//--------------------------------------------------------------------------------------------------
void WJetChargeCorrelationStudyMod::Begin()
{
...
//--------------------------------------------------------------------------------------------------
void WJetChargeCorrelationStudyMod::SlaveBegin()
{
...
//--------------------------------------------------------------------------------------------------
void WJetChargeCorrelationStudyMod::Process()
{
...
//--------------------------------------------------------------------------------------------------
void WJetChargeCorrelationStudyMod::SlaveTerminate()
{
...
//--------------------------------------------------------------------------------------------------
void WJetChargeCorrelationStudyMod::Terminate()
{
